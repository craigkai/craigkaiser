import { c as create_ssr_component, i as is_promise, n as noop, v as validate_component, d as each, e as escape } from "../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<body class="bg-home-sm md:bg-home-md lg:bg-home bg-no-repeat bg-cover h-screen text-white text-xl" style="background-image:url('home/background-home-mobile.jpg')"><div class="flex flex-col items-center p-16 justify-content-center justify-center"><div class="lg:text-5xl self-start font-bold leading-tight text-3xl" data-svelte-h="svelte-xut9oa">Craig Kaiser</div> <div class="mt-4 p-1 self-start text-lg font-normal bg-red-100 text-black rounded">${validate_component(Typewriter, "Typewriter").$$render($$result, { mode: "loop", interval: 100 }, {}, {
    default: () => {
      return `${each(greetings, (greeting) => {
